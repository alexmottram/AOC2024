...
TEST_CASE_TEMPLATE_INVOKE(STANDARD_TEST_CASE, solutions::Day11Solution);
TEST_CASE_TEMPLATE_INVOKE(STANDARD_TEST_CASE, solutions::Day12Solution);
TEST_CASE_TEMPLATE_INVOKE(STANDARD_TEST_CASE, solutions::Day13Solution);
TEST_CASE_TEMPLATE_INVOKE(STANDARD_TEST_CASE, solutions::Day14Solution);
TEST_CASE_TEMPLATE_INVOKE(STANDARD_TEST_CASE, solutions::Day15Solution);
TEST_CASE_TEMPLATE_INVOKE(STANDARD_TEST_CASE, solutions::Day16Solution);
TEST_CASE_TEMPLATE_INVOKE(STANDARD_TEST_CASE, solutions::Day17Solution);
TEST_CASE_TEMPLATE_INVOKE(STANDARD_TEST_CASE, solutions::Day18Solution);
TEST_CASE_TEMPLATE_INVOKE(STANDARD_TEST_CASE, solutions::Day19Solution);
TEST_CASE_TEMPLATE_INVOKE(STANDARD_TEST_CASE, solutions::Day20Solution);
TEST_CASE_TEMPLATE_INVOKE(STANDARD_TEST_CASE, solutions::Day21Solution);
TEST_CASE_TEMPLATE_INVOKE(STANDARD_TEST_CASE, solutions::Day22Solution);
TEST_CASE_TEMPLATE_INVOKE(STANDARD_TEST_CASE, solutions::Day23Solution);
TEST_CASE_TEMPLATE_INVOKE(STANDARD_TEST_CASE, solutions::Day24Solution);
TEST_CASE_TEMPLATE_INVOKE(STANDARD_TEST_CASE, solutions::Day25Solution);
