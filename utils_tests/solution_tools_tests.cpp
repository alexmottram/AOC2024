...
{
public:
    MySolution(): SolutionTemplate(2050, 100, 25, 50, 42, 84)
    {
    }

    int solve_part_a(utils::InputReader input_reader) override { return 25; }
    int solve_part_b(utils::InputReader input_reader) override { return 42; }
};
